import {
  index_esm_default
} from "./chunk-LLZTEF4X.js";
import "./chunk-IYHMIRNV.js";
...
(function() {
  ...
  function Fn(a) {
    ...
    if (S(this).options && S(this).options.apiKey)
      a = index_esm_default.SDK_VERSION ? Oe(index_esm_default.SDK_VERSION) : null, this.a = new Ii(S(this).options && S(this).options.apiKey, Ca(Da), a);
    else
  ...
  (function() {
    if (typeof index_esm_default !== "undefined" && index_esm_default.INTERNAL && index_esm_default.INTERNAL.registerComponent) {
      ...
      index_esm_default.INTERNAL.registerComponent({ name: "auth-internal", instanceFactory: function(b) {
